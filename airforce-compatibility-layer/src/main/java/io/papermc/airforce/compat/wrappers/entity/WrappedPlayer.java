...
public class WrappedPlayer extends WrappedLivingEntity implements Player, io.papermc.airforce.compat.wrappers.inventory.InventoryHolderWrapper {
    ...
    public PlayerInventory getInventory() {
        return new io.papermc.airforce.compat.wrappers.inventory.WrappedPlayerInventory(realPlayer.getInventory(), this.taskDelegator, this);
    }

    @Override
    public Inventory getEnderChest() {
        return new io.papermc.airforce.compat.wrappers.inventory.WrappedInventory(realPlayer.getEnderChest(), this.taskDelegator, this);
    }
