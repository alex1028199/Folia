...
public class WrappedWorld implements World {
    ...
    public List<Entity> getEntities() {
        ...
        for (Entity entity : realEntities) {
            if (entity instanceof Player) {
                wrappedEntities.add(new io.papermc.folia.compat.wrappers.entity.WrappedPlayer((Player) entity, this.taskDelegator));
            } else if (entity instanceof LivingEntity) {
                wrappedEntities.add(new io.papermc.folia.compat.wrappers.entity.WrappedLivingEntity((LivingEntity) entity, this.taskDelegator));
            } else {
                wrappedEntities.add(new io.papermc.folia.compat.wrappers.entity.WrappedEntity(entity, this.taskDelegator));
            }
        }
    ...
    public List<LivingEntity> getLivingEntities() {
        ...
        for (LivingEntity entity : realEntities) {
            if (entity instanceof Player) {
                ...
                wrappedEntities.add(new io.papermc.folia.compat.wrappers.entity.WrappedLivingEntity(entity, this.taskDelegator));
            }
        }
        return Collections.unmodifiableList(wrappedEntities);
    }
    ...
    public <T extends Entity> Collection<T> getEntitiesByClass(Class<T> cls) {
        ...
        for (T entity : realEntities) {
            if (Player.class.isAssignableFrom(cls) && entity instanceof Player) {
                wrappedEntities.add((T) new io.papermc.folia.compat.wrappers.entity.WrappedPlayer((Player) entity, this.taskDelegator));
            } else if (LivingEntity.class.isAssignableFrom(cls) && entity instanceof LivingEntity) {
                wrappedEntities.add((T) new io.papermc.folia.compat.wrappers.entity.WrappedLivingEntity((LivingEntity) entity, this.taskDelegator));
            } else if (Entity.class.isAssignableFrom(cls)) { // Check if cls is Entity or superclass
                 wrappedEntities.add((T) new io.papermc.folia.compat.wrappers.entity.WrappedEntity(entity, this.taskDelegator));
            } else {
    ...
    public List<Player> getPlayers() {
        ...
        for (Player player : realPlayers) {
            wrappedPlayers.add(new io.papermc.folia.compat.wrappers.entity.WrappedPlayer(player, this.taskDelegator));
        }
